...
import { getAnswerToLife } from '@nx-test/test-lib';
import {
  SafeAreaView,
  StyleSheet,
  ScrollView,
...
const App = () => {
  const answerToLife = getAnswerToLife();
        ...
        >
          <View style={styles.header}>
            ...
            <Text style={styles.heading} testID="heading">
              Welcome to TestApp {answerToLife}
            </Text>
          </View>
          <View style={styles.body}>
            <View style={styles.sectionContainer}>
              ...
              <Text style={styles.sectionDescription}>
                Edit <Text style={styles.highlight}>apps/test-app/App.tsx</Text>{' '}
